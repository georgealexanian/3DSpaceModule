Shader "World Political Map/Unlit Earth 16K Scenic Scatter City Lights" 
{
	Properties {
	...
	SubShader 
	{
    	...
    	Pass 
    	{
			...
			float4 frag(v2f i) : SV_Target
			{
                ...
                // Add city lights
                float3 cityLights = tex2D(_CityLights, i.uv).rgb;
                color.rgb += cityLights * (1.0 - i.c1.g) * (1.0 - cloud.g);
