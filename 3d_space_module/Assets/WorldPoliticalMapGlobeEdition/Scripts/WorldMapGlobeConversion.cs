...
namespace WPM {
	public static class Conversion {
		...
		public static  Vector3 GetSpherePointFromLatLon (Vector2 latLon) {
			return GetSpherePointFromLatLon (latLon.x, latLon.y, 0);
		}

		/// <summary>
		/// Converts latitude/longitude/altitude to sphere coordinates
		/// </summary>
		public static  Vector3 GetSpherePointFromLatLon (Vector2 latLon, float altitude) {
		...
		public static Vector2 GetLatLonFromSpherePoint (Vector3 p) {
            ...
            //Debug.Log($"{phi * Mathf.Rad2Deg}  ------   {-theta * Mathf.Rad2Deg}");
