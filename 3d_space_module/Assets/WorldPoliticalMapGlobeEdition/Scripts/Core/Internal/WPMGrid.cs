...
/// Copyright 2017 Ramiro Oliva (Kronnect)
/// </summary>
...
namespace WPM {
	...
	public partial class WorldMapGlobe : MonoBehaviour {
		...
		void HideHighlightedCell () {
			...
			if (lastHighlightedCellIndex >= 0 && lastHighlightedCell.renderer != null && lastHighlightedCell.renderer.sharedMaterial == hexaGridHighlightMaterial) {
