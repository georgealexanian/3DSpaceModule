...
namespace WPM {
	...
	public partial class WorldMapGlobe : MonoBehaviour {
		...
		public LineMarkerAnimator AddLine (Vector3 spherePosStart, Vector3 spherePosEnd, Color color, float arcElevation, float duration, float lineWidth, float fadeOutAfter) {
			return AddLine (spherePosStart, spherePosEnd, color, arcElevation, duration, lineWidth, fadeOutAfter, false);
		}
		...
		public LineMarkerAnimator AddLine (Vector3 spherePosStart, Vector3 spherePosEnd, Color color, float arcElevation, float duration, float lineWidth, float fadeOutAfter, bool reuseMaterial) {
			CheckMarkersLayer ();
