...
namespace WPM {
				...
				public class WorldMapCalculatorInspector : Editor {
								...
								public override void OnInspectorGUI () {
												...
												UNIT_TYPE oldUnit = _calc.fromUnit;
												_calc.fromUnit = (UNIT_TYPE)EditorGUILayout.Popup ((int)_calc.fromUnit, unitNames, GUILayout.MaxWidth (200));
												if (_calc.fromUnit != oldUnit)
																runConversion = true;
												EditorGUILayout.EndHorizontal ();

												switch (_calc.fromUnit) {
