...
public class ManualSimulationController : ControllerSpaceModule
{
    ...
    public bool isSpaceBeingManuallySimulated = false;
    ...
    private void Update()
    {
        ...
        if (SimulationMode.IsGameModeManual() == true)
        {
            ...
            if (manualSimulationButtonClicks.shouldSimulateBackward == true)
            {
            ...
            if (manualSimulationButtonClicks.shouldSimulateForward == true)
            {
                //informing that space is being Manually Simulated
                isSpaceBeingManuallySimulated = true;
