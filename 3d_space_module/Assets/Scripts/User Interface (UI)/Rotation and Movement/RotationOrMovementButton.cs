...
public class RotationOrMovementButton : MonoBehaviour
{
    ...
    public void ShowRotationOrMovementMode(bool shouldSwitchMode = true)
    {
        ...
        {
            Debug.Log("Rotation Mode is ACTIVE");
            ...
            {
                Debug.Log("Turning rotation Mode OFF");
        ...
        {
            Debug.Log("Rotation Mode is INACTIVE");
            ...
            if (shouldSwitchMode == true)
            {
                Debug.Log("Turning Rotation Mode ON");
    ...
    {
        if (_simulationModeToggle.isOn == false)
        {
