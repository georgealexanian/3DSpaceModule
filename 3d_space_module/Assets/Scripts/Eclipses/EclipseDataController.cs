...
public class EclipseDataController : MonoBehaviour
{
    ...
    */
    ...
    {
        Debug.Log("Searching for eclipses");
    ...
    public class EclipseInfo
    {
        ...
        public EclipseInfo(string year, string month, string day, string type, float latitude, float longitude, string width, string time)
        {
            this.year = year;
            this.month = month;
            this.day = day;
