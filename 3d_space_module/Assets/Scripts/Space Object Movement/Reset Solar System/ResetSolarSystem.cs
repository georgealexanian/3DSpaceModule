...
public class ResetSolarSystem : MonoBehaviour
{
    ...
    {
        Debug.Log("starting to reset space");
    ...
    {
        Debug.Log("ending to reset space");
    ...
    public void SaveObjectPositionAndRotationForFutureReset()
    {
        ...
        Debug.Log($"the position of {_parentEarth.name} is {parentEarthLocalPosition}");

        parentMoonLocalPosition = _parentMoon.transform.localPosition;
        Debug.Log($"the position of {_parentMoon.name} is {parentMoonLocalPosition}");

        parentSunLocalPosition = _parentSun.transform.localPosition;
        Debug.Log($"the position of {_parentSun.name} is {parentSunLocalPosition}");
        //

        //saving the rotations of the objects
        earthRotation = _parentEarth.transform.localRotation.eulerAngles;
        Debug.Log($"the rotation of {_parentEarth.transform.name} is {earthRotation}");

        moonRotation = _parentMoon.transform.GetChild(0).transform.localRotation.eulerAngles;
        Debug.Log($"the rotation of {_parentMoon.transform.GetChild(0).name} is {moonRotation}");

        sunRotation = _parentSun.transform.localRotation.eulerAngles;
        Debug.Log($"the rotation of {_parentSun.transform.name} is {sunRotation}");
        //
    }
